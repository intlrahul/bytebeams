...
import 'package:bytebeams_api/src/deserialize.dart';
...
class DefaultApi {
  ...
  Future<Response<BootstrapResponse>> getBootstrap({
    ...
    try {
      ...
      _responseData = rawData == null
          ? null
          : deserialize<BootstrapResponse, BootstrapResponse>(
              rawData,
              'BootstrapResponse',
              growable: true,
            );
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<String>> streamTelemetry({
    String? after,
    String? lastEventID,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
